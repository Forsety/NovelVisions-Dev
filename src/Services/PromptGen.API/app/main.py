...
# API v1 - Visualization (ГЛАВНЫЙ для Visualization.API)
from api.v1.endpoints.visualization import router as visualization_router
app.include_router(visualization_router, prefix="/api/v1/visualization")
...
app.include_router(scene_router, prefix="/api/v1/scenes")

# API v1 - Styles
from api.v1.endpoints.style import router as style_router
app.include_router(style_router, prefix="/api/v1/styles")
...
async def root():
    ...
    return {
        ...
        "docs": "/docs",
        "endpoints": {
            "visualization": "/api/v1/visualization/generate-prompts",
            "prompts": "/api/v1/prompts/enhance",
