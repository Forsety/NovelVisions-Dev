    ...
    : IRequestHandler<CreateTextSelectionVisualizationCommand, Result<VisualizationJobDto>>
{
    ...
    private readonly IBackgroundJobService _backgroundJobService; // ДОБАВЛЕНО
    ...
    public CreateTextSelectionVisualizationCommandHandler(
        ...
        IBackgroundJobService backgroundJobService, // ДОБАВЛЕНО
        IMapper mapper,
        ILogger<CreateTextSelectionVisualizationCommandHandler> logger)
    {
        ...
        _backgroundJobService = backgroundJobService; // ДОБАВЛЕНО
        _mapper = mapper;
        _logger = logger;
    }
        ...
        CancellationToken cancellationToken)
    {
        ...
        // ДОБАВЛЕНО: Запускаем обработку через Hangfire
        await _backgroundJobService.EnqueueProcessJobAsync(job.Id, cancellationToken);
